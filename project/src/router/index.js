...
import Find from '../components/content/find/index.vue'
...
const router = new VueRouter({
    ...
    routes: [
        ...
        {path:'/index',redirect: '/message' ,component:Index,
            children:[
                ...
                {path:'/login',component:()=>import('../components/content/login/login.vue'),
                    meta:{showTabbar:false}
                },
                {path:'/register',component:()=>import('../components/content/login/register.vue')},
                {path:'/detail',component:()=>import('../components/content/detail/index.vue')},
