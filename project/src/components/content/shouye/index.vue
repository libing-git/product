<template>
  <div class="message">
    ...
    <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
      <van-swipe-item>
        <img
          src="https://resource.smartisan.com/resource/f7e26bf3e77ec39fa230d39ee4d3184a.png?x-oss-process=image/resize,w_828/format,webp"
          alt=""
        />
      </van-swipe-item>
      <van-swipe-item>
        <img
          src="https://resource.smartisan.com/resource/15281a93ab968555ba3bd7a911b14f68.png?x-oss-process=image/format,webp"
          alt=""
        />
      </van-swipe-item>
    </van-swipe>
